/*
 * rb_proto.h is a generated file - manual editing is not recommended!
 */
...
symbol *rb_comp_proc_header(char *ident, boolean is_function, LIST *parameters);
void rb_comp_proc_complete(symbol *proc, symbol *last_param, struct scope_info *prev_scope, vm_addr jmp);
...
void rb_comp_proc_call(symbol *proc, boolean as_function, LIST *params, vm_addr begin);
void rb_comp_cache_address(struct addr_cache *cache, vm_addr addr);
boolean rb_comp_region_branch(boolean cont);
void rb_comp_region_close(struct region *prev, vm_addr break_target, vm_addr cont_target);
symbol *rb_comp_get_label(char *ident, boolean at_definition);
void rb_comp_label_call(char *ident);
void rb_comp_label_call_perform(struct lbl_call *lc);
void rb_comp_backpatch_label_calls(symbol *label);
void rb_comp_optimize_operator(struct param *ret, struct param *operand1, struct param *operand2);
